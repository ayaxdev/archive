...
import com.skidding.atlas.event.impl.network.packet.S18RotationEvent;
...
public class S18PacketEntityTeleport implements Packet<INetHandlerPlayClient> {
    ...
    public S18PacketEntityTeleport(Entity entityIn) {
        ...
        S18RotationEvent s18RotationEvent = new S18RotationEvent(entityIn.rotationYaw, entityIn.rotationPitch);
        AtlasClient.getInstance().eventPubSub.publish(s18RotationEvent);

        this.yaw = (byte) ((int) (s18RotationEvent.rotationYaw * 256.0F / 360.0F));
        this.pitch = (byte) ((int) (s18RotationEvent.rotationPitch * 256.0F / 360.0F));
