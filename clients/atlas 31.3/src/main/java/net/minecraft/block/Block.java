...
public class Block {
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity) {
        ...
        if (collidingEntity == Minecraft.getMinecraft().thePlayer) {
            CalculateCollisionEvent calculateCollisionEvent = new CalculateCollisionEvent(this, pos, axisalignedbb);
            AtlasClient.getInstance().eventPubSub.publish(calculateCollisionEvent);
            axisalignedbb = calculateCollisionEvent.boundingBox;
        }
