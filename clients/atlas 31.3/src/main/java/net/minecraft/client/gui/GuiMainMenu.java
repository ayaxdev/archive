...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
    ...
    public void initGui() {
        ...
        synchronized (this.threadLock) {
            ...
            this.openGLWarningY1 = this.buttonList.getFirst().yPosition - 24;
            this.openGLWarningX2 = this.openGLWarningX1 + k;
            this.openGLWarningY2 = this.openGLWarningY1 + 24;
        }
    }

    private void addSingleplayerMultiplayerButtons(int height) {
        this.buttonList.add(new GuiButton(1, this.width / 2 - 100, height, I18n.format("menu.singleplayer")));
        this.buttonList.add(new GuiButton(2, this.width / 2 - 100, height + 24, I18n.format("menu.multiplayer")));
    }
