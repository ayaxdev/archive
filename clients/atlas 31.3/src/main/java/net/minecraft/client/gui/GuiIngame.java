...
public class GuiIngame extends Gui {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        AtlasClient.getInstance().eventPubSub.publish(new Render2DEvent(Event.EventType.PRE, scaledresolution, partialTicks));
        ...
        AtlasClient.getInstance().eventPubSub.publish(new Render2DEvent(Event.EventType.POST, scaledresolution, partialTicks));
        ...
        ShowDebugInfoEvent showDebugInfoEvent = new ShowDebugInfoEvent(mc.gameSettings.showDebugInfo);
        AtlasClient.getInstance().eventPubSub.publish(showDebugInfoEvent);

        if (showDebugInfoEvent.showDebug) {
            if(!showDebugInfoEvent.cancelled)
