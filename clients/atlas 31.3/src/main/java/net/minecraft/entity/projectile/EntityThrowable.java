...
public abstract class EntityThrowable extends Entity implements IProjectile {
    ...
    public EntityThrowable(World worldIn, EntityLivingBase throwerIn) {
        ...
        if (throwerIn == Minecraft.getMinecraft().thePlayer) {
            ThrowableInstanceEvent throwableInstanceEvent = new ThrowableInstanceEvent(yaw, pitch);
            AtlasClient.getInstance().eventPubSub.publish(throwableInstanceEvent);
            yaw = throwableInstanceEvent.rotationYaw;
            pitch = throwableInstanceEvent.rotationPitch;
        }
