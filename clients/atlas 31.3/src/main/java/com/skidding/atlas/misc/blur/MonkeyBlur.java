package com.skidding.atlas.misc.blur;
...
public class MonkeyBlur implements IMinecraft {

    public final Supplier<Float> strength;
    ...
    public void endFrame() {
        ...
        monkeyblurShader.setUniform1f("strength",strength.get() / 2);
    ...
    public boolean isEnabled() {
        return OpenGlHelper.framebufferSupported && !changedPerspective && !Config.isShaders();
    }
