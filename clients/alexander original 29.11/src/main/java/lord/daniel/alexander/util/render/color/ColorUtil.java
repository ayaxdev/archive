...
public class ColorUtil {
    ...
    public Color interpolateColorC(Color color1, Color color2, float amount) {
        amount = Math.min(1, Math.max(0, amount));
        return new Color(InterpolationUtil.interpolate(color1.getRed(), color2.getRed(), amount),
                InterpolationUtil.interpolate(color1.getGreen(), color2.getGreen(), amount),
                InterpolationUtil.interpolate(color1.getBlue(), color2.getBlue(), amount),
                InterpolationUtil.interpolate(color1.getAlpha(), color2.getAlpha(), amount));
    }
