...
import lord.daniel.alexander.event.impl.game.MouseOverEvent;
 ...
 * @author Daniel.
 */
public final class RayCastUtil implements Methods {
    ...
    public static MovingObjectPosition rayCast(final float[] rotation, final double range, final float expand, Entity entity) {
        ...
        if (entity != null && mc.theWorld != null) {
            ...
            final Vec3 vec31 = Entity.getVectorForRotation(rotation[0], rotation[1]);
    ...
    public static MovingObjectPosition rayCast(final float partialTicks, final float[] rots) {
        ...
        if (entity != null && mc.theWorld != null) {
            ...
            final MouseOverEvent mouseOverEvent = new MouseOverEvent(d2, flag, entity);
            Modification.INSTANCE.getBus().post(mouseOverEvent);

            d0 = d2 = mouseOverEvent.getRange();
    ...
    public static Boolean overBlock(final float[] rotation, final BlockPos pos) {
        return overBlock(rotation, EnumFacing.UP, pos, false);
    }

    public static Boolean overBlock(final float[] rotation, final BlockPos pos, final EnumFacing enumFacing) {
