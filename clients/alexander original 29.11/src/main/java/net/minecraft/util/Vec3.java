...
public class Vec3
{
    ...
    {
        return new Vec3(this.xCoord * a, this.yCoord * a, this.zCoord * a);
    }
    ...
    public double distanceTo(AxisAlignedBB bb) {
        Vec3 pos = BBUtil.getNearestPointBB(this, bb);
        double xDist = Math.abs(pos.xCoord - this.xCoord);
        double yDist = Math.abs(pos.yCoord - this.yCoord);
        double zDist = Math.abs(pos.zCoord - this.zCoord);
