...
public class AxisAlignedBB
{
    ...
    public AxisAlignedBB expand(double all)
    {
        double d0 = this.minX - all;
        double d1 = this.minY - all;
        double d2 = this.minZ - all;
        double d3 = this.maxX + all;
        double d4 = this.maxY + all;
        double d5 = this.maxZ + all;
        return new AxisAlignedBB(d0, d1, d2, d3, d4, d5);
    }
    ...
    public double getLookingTargetRange(EntityPlayerSP thePlayer, float[] rotation, double range) {
        ...
        Vec3 direction = (rotation != null ? RotationUtil.toDirection(rotation[0], rotation[1]) : RotationUtil.toDirection(PlayerHandler.yaw, PlayerHandler.pitch)).multiply(range).add(eyes);
        MovingObjectPosition movingObj = this.calculateIntercept(eyes, direction);
    ...
    public double getLookingTargetRange(EntityPlayerSP thePlayer) {
        return getLookingTargetRange(thePlayer, null, 6.0);
    }
