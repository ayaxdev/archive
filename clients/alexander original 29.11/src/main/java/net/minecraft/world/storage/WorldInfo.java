...
public class WorldInfo
{
    ...
    public boolean isThundering()
    {
        ...
        if(ambienceModule.isEnabled() && ambienceModule.getMinecraftWeather() == WeatherUtil.MinecraftWeather.THUNDERSTORM)
            return true;
    ...
    public boolean isRaining()
    {
        ...
        if(ambienceModule.isEnabled()) {
            switch (ambienceModule.getMinecraftWeather()) {
                case CLEAR:
                    return false;
                case SNOWY:
                case RAINY:
