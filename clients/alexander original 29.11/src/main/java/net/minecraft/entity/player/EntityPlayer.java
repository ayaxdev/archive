...
import lord.daniel.alexander.event.impl.game.KnockbackModifierEvent;
import lord.daniel.alexander.handler.plaxer.PlayerHandler;
import lord.daniel.alexander.module.impl.combat.KeepSprintModule;
...
public abstract class EntityPlayer extends EntityLivingBase {
    private KeepSprintModule keepSprint;
    /**
            ...
            if (!targetEntity.hitByEntity(this)) {
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    ...
                    if (flag2) {
                        ...
                        final KnockbackModifierEvent knockbackModifierEvent = new KnockbackModifierEvent(this, i > 0);
                        Modification.INSTANCE.getBus().post(knockbackModifierEvent);
                        ...
                        if (knockbackModifierEvent.isFlag()) {
                            ...
                            // anfek
                            if (keepSprint == null) {
                                keepSprint = ModuleStorage.getModuleStorage().getByClass(KeepSprintModule.class);
                            }
