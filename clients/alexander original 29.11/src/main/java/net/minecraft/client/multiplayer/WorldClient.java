...
public class WorldClient extends World
{
    ...
    TrueSightModule trueSightModule;
    ...
    public void doVoidFogParticles(int p_73029_1_, int p_73029_2_, int p_73029_3_)
    {
        ...
        boolean flag = trueSightModule.isEnabled() || (this.mc.playerController.getCurrentGameType() == WorldSettings.GameType.CREATIVE && itemstack != null && Block.getBlockFromItem(itemstack.getItem()) == Blocks.barrier);
