...
public abstract class EntityLivingBase extends Entity
{
    ...
    public void onEntityUpdate()
    {
        ...
        if(this == Minecraft.getMinecraft().thePlayer) {
            this.prevRotationYawHead = RotationUtil.rotationYaw;
            RotationUtil.lastRotationPitch = RotationUtil.rotationPitch;
        }
    ...
    protected void jump()
    {
        ...
        if (this.isSprinting())
        {
            float f = (this == Minecraft.getMinecraft().thePlayer && RotationUtil.movementAngleCorrection ? RotationUtil.rotationYaw : this.rotationYaw) * 0.017453292F;
    ...
    public void onUpdate()
    {
        ...
        {
            f1 = (this == Minecraft.getMinecraft().thePlayer ? RotationUtil.rotationYaw : this.rotationYaw);
        }
    ...
    {
        float yaw = this == Minecraft.getMinecraft().thePlayer ? RotationUtil.rotationYaw : rotationYaw;
