    ...
    public void updateRidden() {
        if (!this.worldObj.isRemote && this.isSneaking()) {
            ...
            if(this == Minecraft.getMinecraft().thePlayer) {
                ...
                pitch = RotationUtil.rotationPitch;
            }
            float f = yaw;
            float f1 = pitch;
            super.updateRidden();
            ...
            if (this.ridingEntity instanceof EntityPig) {
                ...
                this.rotationYaw = f;
                if(this == Minecraft.getMinecraft().thePlayer) {
                    RotationUtil.rotationYaw = f;
                    RotationUtil.rotationPitch = f1;
                }
            ...
            if (!targetEntity.hitByEntity(this))
            {
                ...
                if (f > 0.0F || f1 > 0.0F)
                {
                    ...
                    if (flag2)
                    {
                        if (i > 0)
                        {
                            float yaw = this == Minecraft.getMinecraft().thePlayer ? RotationUtil.rotationYaw : this.rotationYaw;
