...
public class PlayerUsageSnooper
{
    ...
    private void func_152766_h()
    {
        ...
        this.addStatToSnooper("os_name", "AmigaOS");
        this.addStatToSnooper("os_version", "4.0");
        this.addStatToSnooper("os_architecture", "x86");
        this.addStatToSnooper("java_version", "1.3");
        this.addClientStat("version", "1.2");
