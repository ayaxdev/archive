...
public abstract class Entity implements ICommandSender
{
    ...
    public float getCollisionBorderSize() {
        EntityHitboxEvent hitboxEvent = new EntityHitboxEvent(this, 0.0f);
        AtaniClient.getInstance().eventPubSub.publish(hitboxEvent);
        if(!hitboxEvent.cancelled) {
            return hitboxEvent.size;
        }
        return 0.0f;
    }
