...
import com.atani.nextgen.event.impl.EntityThrowableEvent;
...
public abstract class EntityThrowable extends Entity implements IProjectile
{
    ...
    public EntityThrowable(World worldIn, EntityLivingBase throwerIn)
    {
        ...
        if(throwerIn == Minecraft.getMinecraft().thePlayer) {
            EntityThrowableEvent entityThrowableEvent = new EntityThrowableEvent(yaw, pitch);
            AtaniClient.getInstance().eventPubSub.publish(entityThrowableEvent);
            yaw = entityThrowableEvent.rotationYaw;
            pitch = entityThrowableEvent.rotationPitch;
        }
