...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleEntityTeleport(S18PacketEntityTeleport packetIn)
    {
        ...
        if (entity != null)
        {
            ...
            if(entity == Minecraft.getMinecraft().thePlayer) {
                EntityTeleportEvent entityTeleportEvent = new EntityTeleportEvent(Event.EventType.PRE, posX, posY, posZ, rotationYaw, rotationPitch, -1, -1);
                AtaniClient.getInstance().eventPubSub.publish(entityTeleportEvent);

                posX = entityTeleportEvent.posX;
                posY = entityTeleportEvent.posY;
                posZ = entityTeleportEvent.posZ;

                rotationYaw = entityTeleportEvent.rotationYaw;
                rotationPitch = entityTeleportEvent.rotationPitch;
            }
            ...
            if(entity == Minecraft.getMinecraft().thePlayer)
                AtaniClient.getInstance().eventPubSub.publish(new EntityTeleportEvent(Event.EventType.POST, posX, posY, posZ, rotationYaw, rotationPitch, f, f1));
    ...
    public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn)
    {
        ...
        if (packetIn.func_179834_f().contains(S08PacketPlayerPosLook.EnumFlags.X_ROT))
        {
            ...
            AtaniClient.getInstance().eventPubSub.publish(s08XRotationEvent);
        ...
        if (packetIn.func_179834_f().contains(S08PacketPlayerPosLook.EnumFlags.Y_ROT))
        {
            ...
            AtaniClient.getInstance().eventPubSub.publish(s08YRotationEvent);
            f += s08YRotationEvent.rotationYaw;
        }

        HandlePosLookEvent preEvent = new HandlePosLookEvent(Event.EventType.PRE, f, f1);
        ...
        HandlePosLookEvent midEvent = new HandlePosLookEvent(Event.EventType.MID, preEvent.rotationYaw, preEvent.rotationPitch);
        AtaniClient.getInstance().eventPubSub.publish(midEvent);
        ...
        HandlePosLookEvent postEvent = new HandlePosLookEvent(Event.EventType.POST, midEvent.rotationYaw, midEvent.rotationPitch);
    ...
    public void addToSendQueue(Packet p_147297_1_)
    {
        ...
        AtaniClient.getInstance().eventPubSub.publish(handlePacketEvent);
