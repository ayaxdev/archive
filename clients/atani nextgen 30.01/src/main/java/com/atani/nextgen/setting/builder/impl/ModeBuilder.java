...
public class ModeBuilder extends SettingBuilder<String> {
    ...
    public ModeBuilder(String name, String description, String value, Object[] modes) {
        this.name = name;
    ...
    public SettingFeature<String> build() {
        return new SettingFeature<>(value, name, description,"Mode", this.dependencies, this.valueChangeListeners, this.valueChangeOverrides) {
            @Override
