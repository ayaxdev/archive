...
import lord.daniel.alexander.event.impl.player.HeadLookEvent;
import lord.daniel.alexander.event.impl.player.VelocityEvent;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleEntityVelocity(S12PacketEntityVelocity packetIn)
    {
        ...
        if (entity != null) {
            ...
            Modification.getModification().getPubSub().publish(velocityEvent);
    ...
    public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn)
    {
        ...
        Modification.getModification().getPubSub().publish(headLookEvent);
    ...
    {
        final PacketEvent packetEvent = new PacketEvent(Event.Stage.SENDING, p_147297_1_, this);
        Modification.getModification().getPubSub().publish(packetEvent);
