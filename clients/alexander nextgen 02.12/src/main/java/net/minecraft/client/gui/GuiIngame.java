...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        ShaderHandler.draw(scaledresolution, partialTicks);
        Modification.getModification().getPubSub().publish(new Render2DEvent(Event.Stage.POST, scaledresolution, partialTicks));
