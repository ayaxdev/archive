...
import lord.daniel.alexander.event.impl.player.EntityRendererEvent;
import lord.daniel.alexander.event.impl.player.Render3DEvent;
import lord.daniel.alexander.event.impl.player.RendererEvent;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void getMouseOver(float partialTicks)
    {
        ...
        if (entity != null && this.mc.theWorld != null)
        {
            ...
            Modification.getModification().getPubSub().publish(mouseOverEvent);
    ...
    public void func_181560_a(float p_181560_1_, long p_181560_2_)
    {
        ...
        if (this.mc.inGameHasFocus && flag)
        {
            if (this.pointedEntity instanceof EntityLivingBase) {
                ...
                Modification.getModification().getPubSub().publish(rendererEvent);
            }
            ...
            Modification.getModification().getPubSub().publish(entityRendererEvent);
            ...
            Modification.getModification().getPubSub().publish(rotationEvent);
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        if (this.renderHand && !Shaders.isShadowPass)
        {
            ...
            else
            {
                ...
                Modification.getModification().getPubSub().publish(new Render3DEvent(partialTicks));
            }
