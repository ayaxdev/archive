...
import ja.tabio.argon.event.impl.ItemRaytraceEvent;
...
public class Item
{
    ...
    {
        final ItemRaytraceEvent itemRaytraceEvent = new ItemRaytraceEvent(playerIn, playerIn.rotationYaw, playerIn.rotationPitch);
        Argon.getInstance().eventBus.post(itemRaytraceEvent);
        float f = itemRaytraceEvent.rotationPitch;
        float f1 = itemRaytraceEvent.rotationYaw;
