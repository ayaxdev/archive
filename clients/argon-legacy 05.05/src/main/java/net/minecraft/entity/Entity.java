...
import ja.tabio.argon.event.impl.MoveFlyingEvent;
...
public abstract class Entity implements ICommandSender
{
    ...
    {
        final EntityMovementEvent event = new EntityMovementEvent(this, x, y, z, noClip);
    ...
    {
        final MoveFlyingEvent moveFlyingEvent = new MoveFlyingEvent(this, strafe, forward, friction, this.rotationYaw);
        Argon.getInstance().eventBus.post(moveFlyingEvent);

        if (moveFlyingEvent.cancelled)
            return;

        strafe = moveFlyingEvent.strafe;
        forward = moveFlyingEvent.forward;
        friction = moveFlyingEvent.friction;
