...
import ja.tabio.argon.event.impl.CreateThrowableEntityEvent;
...
public abstract class EntityThrowable extends Entity implements IProjectile
{
    ...
    public EntityThrowable(World worldIn, EntityLivingBase throwerIn)
    {
        ...
        this.setSize(0.25F, 0.25F);
        final CreateThrowableEntityEvent createThrowableEntityEvent = new CreateThrowableEntityEvent(throwerIn, throwerIn.rotationYaw, throwerIn.rotationPitch);
        Argon.getInstance().eventBus.post(createThrowableEntityEvent);
        float yaw = createThrowableEntityEvent.rotationYaw;
        float pitch = createThrowableEntityEvent.rotationPitch;
