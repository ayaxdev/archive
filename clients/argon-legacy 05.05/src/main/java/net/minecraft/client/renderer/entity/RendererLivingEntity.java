...
import ja.tabio.argon.event.impl.RenderPitchHeadEvent;
import ja.tabio.argon.event.impl.RenderYawHeadEvent;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[] {entity, this, Double.valueOf(x), Double.valueOf(y), Double.valueOf(z)}))
        {
            ...
            try
            {
                final RenderYawHeadEvent renderYawHeadEvent = new RenderYawHeadEvent(entity, entity.rotationYawHead);
                Argon.getInstance().eventBus.post(renderYawHeadEvent);

                float f = this.interpolateRotation(entity.prevRenderYawOffset, entity.renderYawOffset, partialTicks);
                float f1 = this.interpolateRotation(entity.prevRotationYawHead, renderYawHeadEvent.rotationYawHead, partialTicks);
                float f2 = f1 - f;
                ...
                final RenderPitchHeadEvent renderPitchHeadEvent = new RenderPitchHeadEvent(entity, entity.prevRotationPitch + (entity.rotationPitch - entity.prevRotationPitch) * partialTicks, partialTicks);
                Argon.getInstance().eventBus.post(renderPitchHeadEvent);
                float f7 = renderPitchHeadEvent.renderPitch;
