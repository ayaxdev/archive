...
public class GuiSlider extends GuiButton
{
    ...
    public GuiSlider(GuiPageButtonList.GuiResponder guiResponder, int idIn, int x, int y, int width, int height, String name, float min, float max, float defaultValue, GuiSlider.FormatHelper formatter)
    {
