...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleEntityTeleport(S18PacketEntityTeleport packetIn)
    {
        ...
        if (entity != null)
        {
            final HandleS18Event handleS18Event = new HandleS18Event(Stage.PRE, entity, packetIn.getX(), packetIn.getY(), packetIn.getZ(), packetIn.getYaw(), packetIn.getPitch(), -1, -1);
            Argon.getInstance().eventBus.post(handleS18Event);

            entity.serverPosX = handleS18Event.posX;
            entity.serverPosY = handleS18Event.posY;
            entity.serverPosZ = handleS18Event.posZ;
            double d0 = (double)entity.serverPosX / 32.0D;
            double d1 = (double)entity.serverPosY / 32.0D;
            double d2 = (double)entity.serverPosZ / 32.0D;
            float f = (float)(handleS18Event.rotationYaw * 360) / 256.0F;
            float f1 = (float)(handleS18Event.rotationPitch * 360) / 256.0F;
            ...
            if (entity == Minecraft.getMinecraft().thePlayer)
                Argon.getInstance().eventBus.post(new HandleS18Event(Stage.POST, entity, packetIn.getX(), packetIn.getY(), packetIn.getZ(), packetIn.getYaw(), packetIn.getPitch(), f, f1));
    ...
    public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn)
    {
        ...
        if (packetIn.func_179834_f().contains(S08PacketPlayerPosLook.EnumFlags.X_ROT)) {
            ...
            Argon.getInstance().eventBus.post(s08XRotationEvent);
        ...
        if (packetIn.func_179834_f().contains(S08PacketPlayerPosLook.EnumFlags.Y_ROT)) {
            ...
            Argon.getInstance().eventBus.post(s08YRotationEvent);
            f += s08YRotationEvent.rotationYaw;
        }

        HandleS08Event preEvent = new HandleS08Event(Stage.PRE, f, f1);
        ...
        HandleS08Event midEvent = new HandleS08Event(Stage.MID, preEvent.rotationYaw, preEvent.rotationPitch);
        Argon.getInstance().eventBus.post(midEvent);
        ...
        HandleS08Event postEvent = new HandleS08Event(Stage.POST, midEvent.rotationYaw, midEvent.rotationPitch);
