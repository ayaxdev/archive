...
import ja.tabio.argon.event.impl.Render3DEvent;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime)
    {
        ...
        if (this.mc.inGameHasFocus && flag)
        {
            ...
            final PlayerRotationEvent playerRotationEvent = new PlayerRotationEvent(mc.thePlayer.rotationYaw, mc.thePlayer.rotationPitch);
            Argon.getInstance().eventBus.post(playerRotationEvent);
        }
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        Argon.getInstance().eventBus.post(new Render3DEvent(partialTicks));
